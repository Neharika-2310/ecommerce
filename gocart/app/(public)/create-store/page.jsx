...
export default function CreateStore() {
        ...
        try {
            ...
            if (["approved", "rejected", "pending"].includes(data.status)) {
                ...
                switch (data.status) {
                    ...
                    case "approved":
                        setMessage("Store has been approved. Now you can add products from your dashboard.");
                        setTimeout(() => router.push("/store"), 5000);
                        break;

                    case "rejected":
                        setMessage("Store has been rejected. Contact the admin for more details.");
                        break;
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            // show immediate applied UI so user knows their click registered
            setAlreadySubmitted(true)
            setStatus('pending')
            setMessage('Applying — waiting for approval')
            setSubmitting(true)
            ...
            // refresh status from server (will keep 'pending' if still pending)
                ...
                <div className="mx-6 min-h-[70vh] my-16">
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            disabled={submitting}
                            className="bg-slate-800 text-white px-12 py-2 rounded mt-10 mb-40 active:scale-95 hover:bg-slate-900 transition disabled:cursor-not-allowed disabled:bg-slate-600"
                        >
